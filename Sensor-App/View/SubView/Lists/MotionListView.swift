                    ...
                    List(self.motionVM.coreMotionArray.reversed(), id: \.counter) { index in
                        HStack{
                            Text("ID:\(self.motionVM.coreMotionArray[index.counter - 1].counter)")
                                .foregroundColor(Color("ListTextColor"))
                            Spacer()
                            Text("R.:\(self.motionVM.coreMotionArray[index.counter - 1].attitudeRoll * 180 / .pi, specifier: "%.4f")")
                                .foregroundColor(Color("ListTextColor"))
                            Spacer()
                            Text("P.:\(self.motionVM.coreMotionArray[index.counter - 1].attitudePitch * 180 / .pi, specifier: "%.4f")")
                                .foregroundColor(Color("ListTextColor"))
                            Spacer()
                            Text("Y.:\(self.motionVM.coreMotionArray[index.counter - 1].attitudeYaw * 180 / .pi, specifier: "%.4f")")
                                .foregroundColor(Color("ListTextColor"))
                            Spacer()
                            Text("H.:\(self.motionVM.coreMotionArray[index.counter - 1].attitudeHeading, specifier: "%.4f")")
                                .foregroundColor(Color("ListTextColor"))
                        }
                        .font(.footnote)
                        //.background(Color("ListBackgroundColor"))
                    ...
                    List(self.motionVM.altitudeArray.reversed(), id: \.counter) { index in
                        HStack{
                            Text("ID:\(self.motionVM.altitudeArray[index.counter - 1].counter)")
                                .foregroundColor(Color("ListTextColor"))
                            Spacer()
                            Text("P.:\(self.motionVM.altitudeArray[index.counter - 1].pressureValue, specifier: "%.5f")")
                                .foregroundColor(Color("ListTextColor"))
                            Spacer()
                            Text("A.:\(self.motionVM.altitudeArray[index.counter - 1].relativeAltitudeValue, specifier: "%.5f")")
                                .foregroundColor(Color("ListTextColor"))
                        }
                        .font(.footnote)
                        //.background(Color("ListBackgroundColor"))
