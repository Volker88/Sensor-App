        ...
        List {
            Section(
                ...
                DisclosureGroup(
                    ...
                    label: {
                        Text("Latitude: \(locationManager.location?.latitude ?? 0.0, specifier: "%.6f")° ± \(locationManager.location?.horizontalAccuracy ?? 0.0, specifier: "%.2f")m")
                    }
                )
                ...
                DisclosureGroup(
                    ...
                    label: {
                        Text("Longitude: \(locationManager.location?.longitude ?? 0.0, specifier: "%.6f")° ± \(locationManager.location?.horizontalAccuracy ?? 0.0, specifier: "%.2f")m")
                    }
                )
