...
class CoreMotionViewModel: ObservableObject {
    ...
    func altitudeUpdateStart() {
        #if targetEnvironment(simulator)
        altitudeArray.append(AltitudeModel(counter: 1, timestamp: SettingsAPI.shared.getTimestamp(), pressureValue: 0.9961142, relativeAltitudeValue: 0.0))
        altitudeArray.append(AltitudeModel(counter: 2, timestamp: SettingsAPI.shared.getTimestamp(), pressureValue: 1.0032622, relativeAltitudeValue: 0.183257))
        altitudeArray.append(AltitudeModel(counter: 3, timestamp: SettingsAPI.shared.getTimestamp(), pressureValue: 1.0195223, relativeAltitudeValue: 0.780832))
        #endif
