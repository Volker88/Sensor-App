...
class CoreMotionViewModel: ObservableObject {
    ...
    func altitudeUpdateStart() {
        #if targetEnvironment(simulator)
        for _ in 1...100 {
        altitudeArray.append(AltitudeModel(counter: 1, timestamp: SettingsAPI.shared.getTimestamp(), pressureValue: 99.61142, relativeAltitudeValue: 0.0))
        altitudeArray.append(AltitudeModel(counter: 1, timestamp: SettingsAPI.shared.getTimestamp(), pressureValue: 100.32622, relativeAltitudeValue: 0.183257))
        altitudeArray.append(AltitudeModel(counter: 1, timestamp: SettingsAPI.shared.getTimestamp(), pressureValue: 101.95223, relativeAltitudeValue: 0.780832))
        }
