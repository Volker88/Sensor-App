...
struct LocationView: View {
    ...
    var body: some View {
        ...
        return List {
            ...
            Text("Speed: \(calculationAPI.calculateSpeed(ms: self.locationVM.coreLocationArray.last?.speed ?? 0.0, to: "\(SettingsAPI.shared.fetchUserSettings().GPSSpeedSetting)"), specifier: "%.2f")\(SettingsAPI.shared.fetchUserSettings().GPSSpeedSetting)")
        }
