...
class MagnetometerViewUITests: XCTestCase {
    ...
    // MARK: - Tests
    func testMagnetometerViewTabBarButtons() {
        // Start Application
        let app = XCUIApplication()
        app.launch()
        
        // Go to Location View
        app.buttons["Magnetometer"].tap()
        sleep(1)
    ...
    func testMagnetometerViewGraphs() {
        // Start Application
        let app = XCUIApplication()
        app.launch()
    ...
    func testMagnetometerViewSlider() {
        // Start Application
        let app = XCUIApplication()
        app.launch()
